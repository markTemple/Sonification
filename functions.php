...
//	$motif_array[] = array('Start codon' =>'ATG');
//	$motif_array[] = array('GATA! binding site' =>'GATA');
//	$motif_array[] = array('Pseudo TATA box' =>'ATTAAA');
//	$motif_array[] = array('Stop codon' =>'TGA');
//	$motif_array[] = array('Stop codon' =>'TAA');
//	$motif_array[] = array('Stop codon' =>'TAG');
//
//return $motif_array;
//}
...
function makeTextstrings($dna_seq, $textCapture){
...
//$text_strings['seqName']
//	$text_strings['seqName'] = 'The Name of this DNA sequence is: <b>';
//	$text_strings['seqName'] .= $_POST["DNAseq_name"].'</b>. ';
...
echo '<embed type="application/x-shockwave-flash" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" quality="best" flashvars="audioUrl=./example_mp3/' . $mp3 .'.mp3" width="500" height="27"></embed>';
