...
<script src="./JZZ-modules-master/javascript/script/JZZ.Midi.js"></script>
<script src="./JZZ-modules-master/javascript/script/JZZ.MidiFile.js"></script>
...
<button id=play class="submitbutton2" onmousedown='play();' disabled>Play</button>
<button id=pause class="submitbutton2" onmousedown='pause();' disabled>Pause</button>
<button id=stop class="submitbutton2" onmousedown='stop();' disabled>Stop</button>
